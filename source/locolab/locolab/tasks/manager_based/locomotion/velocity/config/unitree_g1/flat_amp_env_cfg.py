...
##
@configclass
class G1FlatAmpObservationsCfg:
    ...
    amp_policy: AmpPolicyObsCfg = AmpPolicyObsCfg()
    amp_reference: AmpReferenceObsCfg = AmpReferenceObsCfg()
...
##
@configclass
class G1FlatAmpEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the G1 flat AMP environment."""

    # Scene settings
    scene: G1FlatSceneCfg = G1FlatSceneCfg(num_envs=4096, env_spacing=2.5)
    # Basic settings
    observations: G1FlatAmpObservationsCfg = G1FlatAmpObservationsCfg()
    actions: ActionsCfg = ActionsCfg()
    commands: CommandsCfg = CommandsCfg()
    # MDP settings
    rewards: FlatAmpRewardsCfg = FlatAmpRewardsCfg()
...
@configclass
class G1FlatAmpEnvCfg_PLAY(G1FlatAmpEnvCfg):
