...
@configclass
class TerrainImporterCfg(_TerrainImporterCfg):
    """Configuration for the terrain manager."""

    class_type: type = TerrainImporter  # type: ignore[assignment]
    """The class to use for the terrain importer.

    Defaults to :class:`loco_lab.utils.terrains.terrain_importer.TerrainImporter`.
    """
