...
# REMOTE_LOG_ROOT_PATH="/home/$REMOTE_SERVER_USER/locolab/logs/z_rl/"
...
LOCAL_LOG_ROOT_PATH="$(cd "$(dirname "$0")"/.. && pwd)/logs/z_rl"
...
show_help() {
    ...
    echo "  -p, --path LOG_ROOT_PATH   Remote log root path (example: /home/username/locolab/logs/z_rl/)"
